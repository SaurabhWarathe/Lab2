...
public class EmployerController {
    ...
    public EmployerDto getEmployer(@PathVariable @NotNull String id) {
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.OK)
    public EmployerDto updateEmployer(@PathVariable @NotNull String id, @RequestParam Map<String, String> params) {
        ValidatorUtil.validateParams(params, Arrays.asList("name"));
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.OK)
    public EmployerDto deleteEmployer(@PathVariable @NotNull String id) {
