...
public class CollaboratorController {
    ...
    @PutMapping(value = "/collaborators/{employerId1}/{employeeId1}/{employerId2}/{employeeId2}")
    @ResponseBody
    @ResponseStatus(HttpStatus.OK)
    public SuccessResponseDto createCollaboration(@PathVariable @NotNull String employerId1,
                                                  @PathVariable @NotNull Long employeeId1,
     ...
     *         404 If employee does not exist
     */
    @DeleteMapping(value = "/collaborators/{employerId1}/{employeeId1}/{employerId2}/{employeeId2}")
    @ResponseBody
    @ResponseStatus(HttpStatus.OK)
    public SuccessResponseDto deleteEmployee(@PathVariable @NotNull String employerId1,
                                             @PathVariable @NotNull Long employeeId1,
                                             @PathVariable @NotNull String employerId2,
                                             @PathVariable @NotNull Long employeeId2
    ) {
