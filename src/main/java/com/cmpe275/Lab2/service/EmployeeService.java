...
public class EmployeeService {
    ...
    private Employee setManagerAndEmployer(Employee employee, String managerId, String employerId) {
        ...
        Boolean employerExists = Objects.nonNull(employee.getEmployer());

        if ( employerExists ) {
            Boolean managerExists = Objects.nonNull(employee.getManager());
        ...
        if (Objects.nonNull(managerId)) {
            ...
            if(!manager.isEmpty()) {
                if ((employerId).equals((manager.get().getEmployerId()))) {
        ...
        final Employer employer = employerService.findEmployer(employerId);
