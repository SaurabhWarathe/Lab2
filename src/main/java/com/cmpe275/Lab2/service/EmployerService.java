...
public class EmployerService {
    ...
    //Get Employer
    public Employer findEmployer(final String id) {
        return employerRepository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Employer not found"));
    }

    //Update Employer
    @Transactional
    public Employer updateEmployer(final String id, final Employer fromRequest) {
    ...
    @Transactional
    public Employer deleteEmployer(final String id) {
